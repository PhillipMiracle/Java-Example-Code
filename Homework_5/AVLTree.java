...
public class AVLTree<E extends Comparable<E>> extends BST<E> {
  ...
  {
	  AVLTreeNode<E> left = (AVLTreeNode<E>) root.left;
	  AVLTreeNode<E> right = (AVLTreeNode<E>) root.right;
	  if ((left == null) && (k == 1))
		  return root.element;
	  else if((left == null) && (k == 2))
		  ...
		  return find(k - left.size - 1, right);
